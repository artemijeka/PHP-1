...
////////////////////////////////////////////////////////////////////////////////////////////////////
/***************************** ТИПЫ ПЕРЕМЕННЫХ И РЕЗУЛЬТАТ ФУНКЦИИ: *****************************/
// ЯВНОЕ ЗАДАНИЕ ТИПА ПЕРЕМЕННОЙ:
(int)$var = 5;// тип переменной указывается перед переменной в скобках через пробел
// ЯВНОЕ ЗАДАНИЕ ТИПА АРГУМЕНТА
function example(int $number)// для аргументов функции можно указывать явно тип аргумента такие как int string boolean array и т.п.
{
    return $number;
}
