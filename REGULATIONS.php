...
asort($assoc_array); // сортирует значения массива по алфавиту и возрастанию цифр, при этом не сбрасывая ключи ассоциативного массива
