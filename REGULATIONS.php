...
function example($number) : int { // для функции после объявления фунцкии и ":" уквзывается тип возвращаемого результат
    return $number;
}
/* Имя класса */
...
В этом случае значение будет присвоено по ссылке. */
