...
$array_string = string_split_unicode($string);
...
function transliterator_rus_array($array_string) {
	$array_letters = array(
		'а' => 'a', 'б' => 'b', 'в' => 'v',
		'г' => 'g', 'д' => 'd', 'е' => 'e',
		'ё' => 'e', 'ж' => 'zh', 'з' => 'z',
	...
	foreach($array_string as $value) {
		// var_dump($value);
		if (array_key_exists($value, $array_letters)) {
			$trans_string .= $array_letters[$value];
		}
		// var_dump($trans_string);
	}
	return $trans_string;
}
print_r( transliterator_rus_array($array_string) );
////////////////////////////////////////////////////////////////////////////////
echo "</pre><hr>";
////////////////////////////////////////////////////////////////////////////////